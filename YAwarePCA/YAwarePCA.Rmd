...
Note that the noise variables typically have large significance values, denoting statistical insignificance.  Usually we [recommend doing some pruning on variables before moving on](http://www.win-vector.com/blog/2014/02/bad-bayes-an-example-of-why-you-need-hold-out-testing/), but for this example we will attempt dimensionality reduction before pruning.
